...
function StaffExplorador({ data, createCourse, createSubject, assignStudentToCourse }) {
...
export default function App() {
  ...
  if (user.role === "alumno") {
    ...
    if (view === "explorador") content = <StaffExplorador data={data} createCourse={createCourse} createSubject={createSubject} assignStudentToCourse={assignStudentToCourse} />;
